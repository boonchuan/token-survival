...
- **Feder et al. (2018)** report 44% of coins "abandoned at least temporarily" with 71% resurrection, implying 18% permanent abandonment in their 1,082-coin sample (2013–2018). Our 83% Feder re-implementation incorporates a longer time horizon (eleven years versus five), a much larger sample (28,123 versus 1,082, including the 2018–2024 cohorts that postdate their study), and treats Path B disappearance from CMC tracking as a death event. The most direct comparable figure — Feder's "abandoned at least temporarily" rate restricted to comparable cohorts — would require restricting our sample to pre-2018 listings; we leave that finer-grained reconciliation to future work.
